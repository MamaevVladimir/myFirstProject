...
public abstract class ZooAnimal {// если у класса убрать abstract, в нём нельзя
    ...
    // Метод без реализации: абстрактный метод
    // Здесь не конкретное животное, а набор требований которые у каждого животного
    // Писать конструкторы в абстрактном классе бессмысленно,
    // а переменные и методы get, set допустимо
